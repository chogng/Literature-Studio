const zh = {
  ...
  settingsLlmModel: '\u6a21\u578b',
  settingsLlmModelPlaceholder: '\u4f8b\u5982 glm-4.6 \u6216 deepseek-chat',
  settingsLlmBaseUrl: 'Base URL',
  settingsLlmBaseUrlPlaceholder: '\u804a\u5929\u63a5\u53e3\u7684 Base URL',
  settingsLlmTestConnection: '\u6d4b\u8bd5',
  settingsLlmShowApiKey: '\u663e\u793a',
  settingsLlmHideApiKey: '\u9690\u85cf',
  settingsLlmHint:
    '\u6bcf\u4e2a provider \u7684 API Key\u3001\u6a21\u578b\u548c Base URL \u90fd\u4f1a\u5355\u72ec\u4fdd\u5b58\uff0c\u5207\u6362 provider \u65f6\u4e0d\u4f1a\u4e22\u5931\u4e4b\u524d\u7684\u914d\u7f6e\u3002',
  statusError: '错误',
  statusInfo: '状态',
  statusReady: '就绪',
  errorUnknown: '未知错误。',
