const zh = {
  ...
  settingsTextEditorFontFamily: '默认字体',
  settingsTextEditorFontSize: '默认字号',
  settingsTextEditorLineHeight: '默认行高',
  settingsTextEditorColor: '默认文字颜色',
  ...
  editorToolbarSourcesEmpty: '暂无链接',
  editorTitle: '写作工作台',
