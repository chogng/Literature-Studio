const zh = {
  ...
  editorSplitMode: '分栏',
  editorSourceMode: '来源',
  editorDraftTitle: '草稿标题',
  editorDraftTitlePlaceholder: '给当前章节或稿件写一个工作标题',
  editorDraftBodyPlaceholder:
    '在这里开始写作。如果你没有在右侧助手栏单独填写“写作上下文”，当前草稿会自动作为上下文送入 LLM。',
  editorWordCount: '词数：',
  editorCharacterCount: '字数：',
  editorParagraphCount: '段落：',
  editorClearDraft: '清空草稿',
  editorLatestAssistant: '最近一次助手回答',
  editorInsertAssistantAnswer: '插入回答',
  editorInsertAssistantEvidence: '插入证据笔记',
  editorSourceTitle: '来源预览',
  editorNoAssistantYet:
    '先在右侧运行一次助手问答，这里就可以把回答或证据插入到正文。',
