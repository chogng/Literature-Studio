const en = {
  ...
  settingsLlmModelPlaceholder: 'Model name, for example glm-4.6 or deepseek-chat',
  settingsLlmBaseUrl: 'Base URL',
  settingsLlmBaseUrlPlaceholder: 'Base URL for chat completions',
  settingsLlmTestConnection: 'Test',
  settingsLlmShowApiKey: 'Show',
  settingsLlmHideApiKey: 'Hide',
  settingsLlmHint:
    'Provider, model, base URL, and API key are saved locally so switching providers does not lose previous values.',
  statusError: 'Error',
  statusInfo: 'Status',
  statusReady: 'Ready',
