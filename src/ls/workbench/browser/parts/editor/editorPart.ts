...
export function createEditorPartProps({
  ...
  return {
    labels: {
      ...
      toolbarSourcesRecent: ui.editorToolbarSourcesRecent,
      toolbarSourcesFavorites: ui.editorToolbarSourcesFavorites,
      toolbarSourcesEmpty: ui.editorToolbarSourcesEmpty,
