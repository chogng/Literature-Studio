import type { TranslationProviderId, TranslationProviderSettings } from '../../../../base/parts/sandbox/common/desktopTypes.js';
import type { SettingsPartLabels } from './settingsTypes.js';
import { ApiKeyFieldView } from './apiKeyField.js';
